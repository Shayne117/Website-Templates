...
<link rel="stylesheet" href="Sections/css/header-section.css">
<section id="header" class="header-container dark-theme">
  <div class="header-content">
    ...
    <div class="image-block-header">
      <img src="Sections/images/image_3.jpg" alt="Web design illustration">
    </div>
